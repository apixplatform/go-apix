...
export class ScoringService {
  ...
  login(APIXToken?: string): Observable<any> {
    const headers: HttpHeaders = APIXToken
      ? this.commonOptions.headers.append(
          'X-Authorization',
          'bearer ' + APIXToken
        )
    ...
    return this.http.post(this.config.scoreApi.url.loginEndpoint, body, {
      headers
    });
  }
  ...
  createReq(
    ...
    return this.http.post(this.config.scoreApi.url.createReqEndpoint, body, {
      headers
    });
  }
  ...
  verifyReq(
    ...
    params = params
      .append('request_id', body.request_id)
      .append('otp', body.otp);

    return this.http.get(this.config.scoreApi.url.verifyReqEndpoint, {
      headers,
      params
    });
  }
  ...
  getScore(
    ...
    return this.http.post(this.config.scoreApi.url.scoreReqEndpoint, body, {
      headers
    });
  }
}
